...
<body>
    ...
    List<CustomerPurchasePojo> salesData = customerPurchaseDAO.getCustomerPurchasesByUserId(currentLoginUserId);

    float totalPurchase = 0;
    float totalBalance = 0;

    for (CustomerPurchasePojo purchase : salesData) {
...
%>
        	<tr>
                ...
                <td><%= balance %></td>
                <td><%= date %></td>
                <td><%= invoiceNo %></td> <!-- Use getInvoiceNo directly -->
...
%>     
    ...
    <div class="total-card">
        <span class="total-label">Total Sale:</span> <%= totalPurchase %>
    </div>
    <div class="total-card">
        <span class="total-label">Total Balance:</span> <%= totalBalance %>
    </div>
    <br>
			<a class="a1" href="InvoiceCustomer.jsp"><input class="btn btn-primary" type="button" value="+New Sale"></a>
