...
<body>
			...
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="nav-link"><a href="CustomerInvoice.jsp"> <i
							class='bx bx-check-shield icon'></i> <span class="text nav-text">Invoice</span>
					</a></li>
	...
	<table>
        ...
        <tbody>
            ...
            List<SupplierPurchase> customerPurchases = supplierPurchaseDAO.getSupplierPurchaseByUserId(userId);
               for (SupplierPurchase purchase : customerPurchases) { %>
                <tr>
                    ...
                    <td>
                        <a href="DownloadInvoiceServlet1?invoiceNo=<%= purchase.getInvoiceNo() %>">Download PDF</a>
                    </td>
                </tr>
            <% } %>
        </tbody>
